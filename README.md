...
2. Ensure docker daemon is operating by starting the application. You should be able to run 'docker' at the command line without error.
3. Building for Mac requires [this step](#building-binaries-for-mac-os-x) to be completed
