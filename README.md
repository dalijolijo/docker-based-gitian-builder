...
2. Clone or fork [this](https://github.com/dalijolijo/docker-based-gitian-builder) GH repo with 
```
git clone https://github.com/dalijolijo/docker-based-gitian-builder.git
```
