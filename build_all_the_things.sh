...
# exmaple:   bash build_all_the_things.sh v0.14.1 bitcore/bitcore
# this will build:
...
repo="https://github.com/LIMXTEC/BitCore.git"

get_latest_tag () {
  local url="curl ${masterApiEndpoint}/repos/limxtec/bitcore/tags"
